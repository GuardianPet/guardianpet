...
function pagarStripe(){
  ...
  var STRIPE_LINKS = {
    anual:  'https://buy.stripe.com/test_8x29AM5Mp9Ss6Ai5MN8Vi00', // ⚠️ SUBSTITUIR pelo link de produção no Stripe Dashboard
    mensal: 'https://buy.stripe.com/test_9B6cMYa2FggQ6Ai8YZ8Vi01'  // ⚠️ SUBSTITUIR pelo link de produção no Stripe Dashboard
  };
...
function saveMed(){
  ...
  if(btn){btn.disabled=false;btn.textContent='Salvar medicamento ✓';}
  toast('Erro ao salvar medicamento. Tente novamente.');
});
}
